...
public class GameCoreService {
    ...
    public SubmissionResult submit(Level level, String expr, long elapsedSeconds) {
        ...
        try {
            ...
            return new SubmissionResult(false, new ScoreResult(false, false, false, 0), List.of(), null,
                    "解析失败: " + e.getMessage());
        }
        ...
        try {
            ...
            return new SubmissionResult(false, new ScoreResult(false, false, false, 0), ctx.trace(), null,
                    "运行错误: " + e.getMessage());
        }
